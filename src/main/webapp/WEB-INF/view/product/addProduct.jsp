		...
		<form action="product?action=add" method="post" class="space-y-6">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div>
					<label for="quantity"
						...
						placeholder="0" min="0" value="${quantity}"
			...
			<div>
				...
				<textarea id="description" name="description"
					...
					class="w-full px-4 py-3 border ${fieldErrors.description != null ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-cyan-500 focus:border-cyan-500'} rounded-lg transition-colors duration-200 min-h-[120px] resize-none">${description}</textarea>
