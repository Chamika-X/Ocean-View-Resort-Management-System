		...
		<form action="customer" method="post" class="space-y-6">
			...
			<div>
				...
				<textarea id="address" name="address" required
					...
					class="w-full px-4 py-3 border ${fieldErrors.address != null ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-cyan-500 focus:border-cyan-500'} rounded-lg transition-colors duration-200 min-h-[120px] resize-none">${address}</textarea>
