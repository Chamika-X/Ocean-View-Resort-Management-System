        ...
        <form action="guest" method="post">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="tel" id="contactNumber" name="contactNumber" value="${guest.contactNumber}"
                ...
                <div>
                    <label for="nicPassport" class="block text-sm font-medium text-gray-700 mb-2">NIC / Passport</label>
                    <input type="text" id="nicPassport" name="nicPassport" value="${guest.nicPassport}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400">
                </div>
                ...
                <div>
                    ...
                    <select id="nationality" name="nationality"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400">
                        <option value="Sri Lankan" ${guest.nationality == 'Sri Lankan' ? 'selected' : ''}>Sri Lankan</option>
                        <option value="Indian" ${guest.nationality == 'Indian' ? 'selected' : ''}>Indian</option>
                        <option value="British" ${guest.nationality == 'British' ? 'selected' : ''}>British</option>
                        <option value="American" ${guest.nationality == 'American' ? 'selected' : ''}>American</option>
                        <option value="Australian" ${guest.nationality == 'Australian' ? 'selected' : ''}>Australian</option>
                        <option value="German" ${guest.nationality == 'German' ? 'selected' : ''}>German</option>
                        <option value="French" ${guest.nationality == 'French' ? 'selected' : ''}>French</option>
                        <option value="Chinese" ${guest.nationality == 'Chinese' ? 'selected' : ''}>Chinese</option>
                        <option value="Japanese" ${guest.nationality == 'Japanese' ? 'selected' : ''}>Japanese</option>
                        <option value="Other" ${guest.nationality == 'Other' ? 'selected' : ''}>Other</option>
                    </select>
                </div>
