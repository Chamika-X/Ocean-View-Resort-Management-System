...
<div class="px-8 py-6 max-w-3xl">
    <div class="mb-6">
        ...
        <p class="text-gray-600">Update room information</p>
    </div>
        ...
        <form action="room" method="post">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="roomTypeId" name="roomTypeId"
                        ...
                        <c:forEach var="type" items="${roomTypes}">
                            <option value="${type.roomTypeId}" ${room.roomTypeId == type.roomTypeId ? 'selected' : ''}>
                ...
                <div>
                    ...
                    <input type="number" id="floorNumber" name="floorNumber" value="${room.floorNumber}"
                        min="1" max="50"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400"
                        placeholder="Enter room description (optional)">${room.description}</textarea>
                </div>
